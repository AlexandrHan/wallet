...
class SalesProjectController extends Controller
{
    private function constructionFieldMeta(): array
    {
        $meta = [
            ...
            'mounting_system' => ['section' => 'Обладнання', 'label' => 'Система кріплень'],
    ...
    public function index(Request $request)
    {
        ...
        $col = [
            ...
            'mounting_system'          => Schema::hasColumn('sales_projects', 'mounting_system'),
        ...
        $projects = $projects->map(function ($project) use ($userNames, $amoComplectationByProjectId, $transfersByProjectId, $amoStatusByProjectId, $qcByProject, $attachmentsByProject, $scheduleEntriesByProject, $col, $walletOwnerById, $workerMatchValue) {
            ...
            return [
                ...
                'amo_stage_id' => $amoStatusByProjectId->get($project->id) ? (int) $amoStatusByProjectId->get($project->id) : ($project->manual_amo_stage_id ? (int) $project->manual_amo_stage_id : null),
                ...
                'mounting_system' => $col['mounting_system'] ? $project->mounting_system : null,
    ...
    public function updateConstruction(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'mounting_system' => 'nullable|string|max:500',
