...
<main class="wrap stock-wrap">
    ...
    @if(auth()->user()->role === 'owner')
        <div class="card" style="margin-bottom:20px;">
            <button class="btn primary" onclick="openSendCashModal()" style="width:100%">Передати кошти менеджеру</button>
        </div>
    @endif
    ...
    @if(auth()->user()->role === 'sunfix_manager')
...
async function loadCashTransfers(){
    ...
    const list = document.getElementById('cashTransfersList');
    if (!list) return;
