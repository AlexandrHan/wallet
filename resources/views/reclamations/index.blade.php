...
<main class="wrap page">
 ...
 <a href="/reclamations/21" class="card reclam-card reclam-link">
  ...
  <script>
    // щоб header був однаковий по UX з wallet
    ...
    // default
    setOwnerUI(window.AUTH_USER?.actor === 'kolisnyk' ? 'kolisnyk' : 'hlushchenko');
  </script>
</body>
</html>
